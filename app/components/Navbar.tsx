...
export default function Navbar() {
    ...
    const renderDropdown = (type: "dienst" | "blog" | "user") => {
        ...
        if (type === "user") {
            return (
                <div
                    className={`absolute right-0 mt-2 w-48 bg-white text-black shadow-xl rounded-lg overflow-hidden transition-all duration-300 ${openDropdown === "user"
        ...
        return (
            <div
                className={`absolute left-0 mt-2 ${width} bg-white text-black shadow-xl rounded-lg overflow-hidden transition-all duration-300 ${openDropdown === type
                        ? "opacity-100 translate-y-0"
                        : "opacity-0 -translate-y-2 pointer-events-none"
                    }`}
            >
    ...
    return (
        <nav className="flex flex-col lg:flex-row justify-between items-center px-6 py-4 bg-gradient-to-r from-gray-900 to-blue-900 text-white shadow-lg">
            ...
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-center w-full lg:w-auto">
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-center">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        >
                            Dienstleistungen
                            <svg
                                className={`ml-1 h-4 w-4 transition-transform duration-300 ${openDropdown === "dienst" ? "rotate-180" : ""
                                    }`}
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        >
                            Blog
                            <svg
                                className={`ml-1 h-4 w-4 transition-transform duration-300 ${openDropdown === "blog" ? "rotate-180" : ""
                                    }`}
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                ...
                {/* RIGHT SIDE → Icons for Login/Register/User */}
